<div class="title-block" style="float: left; display: flex; background-color: #F1C232; width: 100%; height: calc(100% - 90%) !important;">
    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light" style="padding: 0 !important;float: left; width: 100%; margin-bottom: 20px;">
        <a href="http://localhost:3000/index.php" class="button" id="button" style="border-radius: 0 !important; background-color: #FFE79C !important;padding: 13px 0px !important;margin: 0 !important; width: 25%; text-align: center; color: black !important; font-weight: bold; font-family: Open Sans;">INICIO</a>
        <a href="http://localhost:3000/protectoras.php" class="button" id="button" style="border-radius: 0 !important;background-color: #FFE79C !important;padding: 13px 0px !important;margin: 0 !important;width: 25%; text-align: center; color: black !important; font-weight: bold; font-family: Open Sans;">PROTECTORAS</a>
        <a href="http://localhost:3000/darenadopcion.php" class="button" id="button" style="border-radius: 0 !important;background-color: #FFE79C !important;padding: 13px 0px !important;margin: 0 !important;width: 25%; text-align: center; color: black !important; font-weight: bold; font-family: Open Sans;">DA EN ADOPCIÓN</a>
        <a href="#" class="button" id="button" style="border-radius: 0 !important;background-color: #FFE79C !important;margin: 0 !important;padding: 13px 0px !important;width: 25%; text-align: center; color: black !important; font-weight: bold; font-family: Open Sans;">¿QUIÉNES SOMOS?</a>
